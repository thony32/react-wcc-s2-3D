                ...
                <div className='flex items-center justify-center gap-3 animate-pulse'>
                    <svg className='w-4 stroke-current' viewBox="0 0 24 24" fill="none">
                        ...
                        <path
                            ...
                            strokeWidth="1.5" />
                        <path d="M22 8L12 12" strokeWidth="1.5" strokeLinecap="round" />
                        <path
                            ...
                            fill="#1C274C" />
                        <path d="M7 11V6.5V2" strokeWidth="1.5" strokeLinecap="round" />
                        <circle cx="4.5" cy="10.5" r="2.5" strokeWidth="1.5" />
                        <path d="M10 5C8.75736 5 7 4.07107 7 2" strokeWidth="1.5" strokeLinecap="round" />
                    </svg>
