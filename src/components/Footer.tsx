...
function Footer() {
  return (
    <div className="relative lg:px-[10%] h-[35vh] flex items-end">
      ...
      <footer className="footer items-center p-12 lg:p-4 lg:bg-transparent bg-primary text-neutral-content z-20">
        <div className="items-center grid-flow-col">
          ...
          <p>Copyright © 2023 - All rights reserved to Team RAYA WCC S2</p>
        </div>
