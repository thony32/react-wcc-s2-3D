      ...
      <div>
        <div className="flex justify-center">
          <div className="card w-5/6 bg-neutral text-neutral-content mx-auto">
            <div className="card-body gap-y-28 my-10">
              <div className="flex justify-center">
                <div className="text-center space-y-2">
                  <h2 className="text-left text-2xl">Ireo lalao</h2>
                  <p className="fortnite text-left text-7xl">Inona avy ary ireo karazana lalao?</p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 divide-x-2 px-44 ">
                <div className="flex justify-start items-center">
                  <div className="mx-6 space-y-10">
                    <svg className="stroke-base-100 w-12 h-12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h1 className="font-bold text-3xl">Mitovy</h1>
                ...
                <div className="flex justify-center items-center">
                  <div className="mx-6 space-y-10">
                    ...
                    <div className="space-y-2">
                    <h1 className="font-bold text-3xl">Lokoy</h1>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Qui facere sint animi saepe doloribus nobis autem nostrum totam </p>
                    </div>
                  </div>
                </div>
                <div className="flex justify-center">
                  ...
                  <div className="mx-6 space-y-10">
                    ...
                    <div className="space-y-2">
                    <h1 className="font-bold text-3xl">Kotio</h1>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Qui facere sint animi saepe doloribus nobis autem nostrum totam</p>
                    </div>
                  </div>
                </div>
