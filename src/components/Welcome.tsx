      ...
      <svg className="absolute bottom-[15%] -rotate-45 right-[55%] hidden sm:block" width="200" viewBox="0 0 150 149.999998" height="200">
        <defs>
          ...
          <clipPath id="727ed35774">
            <path d="M 74 75 L 145.003906 75 L 145.003906 147.515625 L 74 147.515625 Z M 74 75 " clip-rule="nonzero" />
          </clipPath>
          <clipPath id="2383711c1d">
            <path d="M 38 2.765625 L 109 2.765625 L 109 76 L 38 76 Z M 38 2.765625 " clip-rule="nonzero" />
          </clipPath>
        </defs>
        <g clip-path="url(#5d53806b99)">
          <path fill="#f4e44d"
